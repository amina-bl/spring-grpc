...
public class CompteServiceImpl extends CompteServiceGrpc.CompteServiceImplBase {
    ...
    public void findComptesByType(FindComptesByTypeRequest request, StreamObserver<FindComptesByTypeResponse> responseObserver) {
        try {
            ma.projet.grpc.entities.TypeCompte type = request.getType() == ma.projet.grpc.stubs.TypeCompte.COURANT ?
                    ma.projet.grpc.entities.TypeCompte.COURANT : ma.projet.grpc.entities.TypeCompte.EPARGNE;
    ...
    private ma.projet.grpc.stubs.Compte mapToGrpcCompte(Compte compte) {
        ma.projet.grpc.stubs.TypeCompte type = compte.getType() == ma.projet.grpc.entities.TypeCompte.COURANT ?
